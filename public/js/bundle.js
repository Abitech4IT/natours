        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Logged In succefully!');
...
var displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/abitech/cl6y6sd1i00nu14pdo0hl26s1',
    // style URL
    scrollZoom: false // center: [-118.116524, 34.115720], // starting position [lng, lat]
...
var stripe = (0, _stripeJs.loadStripe)('pk_test_51LbnduJ1JjixMdSvIHkmOx28AUOBbho2ntxSOT4ErvQkPq7d2RhSpEgDjT6GSMyxzOcBBc8Df3Zzlrz91ncX7NWl00a0UKekXH');
